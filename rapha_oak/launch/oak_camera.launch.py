...
def generate_launch_description():
    rapha_oak_prefix = get_package_share_directory("rapha_oak")

    declared_arguments = [
        DeclareLaunchArgument("name", default_value="oak"),
        DeclareLaunchArgument("params_file", default_value=os.path.join(rapha_oak_prefix, 'config', 'pcl_oak.yaml')),
    ]
